...
#ifndef G4PSCellFluxToDose_h
#define G4PSCellFluxToDose_h 1
...
class G4PSCellFluxToDose : public G4VPrimitiveScorer
{
   public: // with description
      G4PSCellFluxToDose(G4String name, G4int depth=0);
      G4PSCellFluxToDose(G4String name, const G4String& unit, G4int depth=0);
      virtual ~G4PSCellFluxToDose();
